  ...
  render() { 
    return ( 
      <div>
        ...
        <h3>Nous vous proposons pour votre sécurité ....</h3>

        <h1>Maîtrise & pédagodie</h1>
        <ul>
        ...
        <h5>Des formations à la carte</h5>
        <h5>Nous apportons nos compétences</h5>
        <h5>Vous apportez  vos exigences</h5>
        <h5>Nous personnalisons vos formations</h5>


        <h1>Un catalogue de formation complet</h1>
        <h6> (incendie - hygiène sécurité - secourisme)</h6>
        <ul>
